...
export default Controller.extend({
  ...
  dataprofileDownload() {
    ...
    return `https://planninglabs.carto.com/api/v2/sql?format=csv&q=SELECT ${columns} FROM community_district_profiles_v201810&filename=${model.get('boro')}-${model.get('cd')}-indicators.csv`;
  },
