...
export default Controller.extend({
  ...
  dataprofileDownload() {
    ...
    return `https://planninglabs.carto.com/api/v2/sql?format=csv&q=SELECT ${columns} FROM community_district_profiles_v202102&filename=${model.get('boro')}-${model.get('cd')}-indicators.csv`;
  },
